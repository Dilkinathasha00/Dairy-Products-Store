...
<section class="display-orders">
   ...
   ?>
   <p> <?= $fetch_cart_items['name']; ?> <span>(<?= 'LKR'.$fetch_cart_items['price'].'/- x '. $fetch_cart_items['quantity']; ?>)</span> </p>
   <?php
    }
   }else{
   ...
   ?>
   <div class="grand-total">grand total : <span>LKR<?= $cart_grand_total; ?>/-</span></div>
</section>
